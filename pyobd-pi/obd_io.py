...
class OBDPort:
     ...
     def __init__(self,portnum,_notify_window,SERTIMEOUT,RECONNATTEMPTS):
         ...
         try:
            ...
            #print(str.encode("atz"))
            #self.send_command(str.encode("atz"))   # initialize
            time.sleep(1)
     ...
     def interpret_result(self,code):
         ...
         code = string.split(code, "\r")  ###python2
         #code = str.split(code, "\r")###jwg  python3
         code = code[0]
         
         #remove whitespace
         code = string.split(code)  ###python2
         #code = str.split(code)##jwg  ###python3
         code = string.join(code, "")  ###python2
         #code = str.join("",code)##jwg  ###python3
